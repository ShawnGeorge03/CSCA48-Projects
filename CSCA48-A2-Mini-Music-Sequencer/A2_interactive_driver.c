...
int main()
{
	...
	root=BST_harmonize(root,semitones,time_shift);
      ...
      if (choice==11)
      {
        new_note = newBST_Node(440.0, 2, .25); //A4
        root=BST_insert(root,new_note);
        new_note = newBST_Node(329.63, 2, .75);
        root=BST_insert(root,new_note);
        new_note = newBST_Node(880.0, 2, .5);
        root=BST_insert(root,new_note);
        new_note = newBST_Node(587.33, 1, .75);
        root=BST_insert(root,new_note);
        new_note = newBST_Node(932.33, 1, .95);
        root=BST_insert(root,new_note);
        new_note = newBST_Node(207.65, 2, .15);
        root=BST_insert(root,new_note);
        new_note = newBST_Node(369.99, 2, .10);
        root=BST_insert(root,new_note);
      }
