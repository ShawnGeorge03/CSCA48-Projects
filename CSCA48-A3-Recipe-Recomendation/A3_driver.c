...
#include<stdio.h>
#include<stdlib.h>
#include"ingredient_graph_1006094673.c"
...
int main()
{
   ...
   printf("medium shrimp : %d\n", ingredient_index("medium shrimp"));
   printf("Medium Shrimp : %d\n", ingredient_index("Medium Shrimp"));
   printf("artichoke hearts : %d\n", ingredient_index("artichoke hearts"));

   printf("\n------- The available ingredients should appear above this line -------\n");
   ...
   printf("\n");
   for(int i = 0; i < MAT_SIZE; i++) printf("%d ",visited[i]);
   printf("\n");
   for(int i = 0; i < MAT_SIZE; i++) visited[i] = 0;
